...
@section('content')
<div class="row">
    <div class="col-12 pb-5 d-none d-sm-none">
        <button type="button" class="btn btn-secondary btn-lg">ทั้งหมด</button>
        <div class="btn-group mr-5 ml-5" role="group" aria-label="Basic example">
            <button type="button" class="btn btn-secondary btn-lg">ร่าง</button>
            <button type="button" class="btn btn-secondary btn-lg">ยังไม่จ่าย</button>
            <button type="button" class="btn btn-secondary btn-lg">โอนแล้ว</button>
            <button type="button" class="btn btn-secondary btn-lg">เตรียมส่ง</button>
            <button type="button" class="btn btn-secondary btn-lg">ส่งแล้ว</button>
        </div>
        <button type="button" class="btn btn-secondary btn-lg">ยกเลิก</button>
    </div>
</div>
<div class="row row row-cards row-deck">
    <div class="col-12">
        <div class="card">
